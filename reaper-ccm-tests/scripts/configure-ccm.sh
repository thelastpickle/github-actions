...
case "${TEST_TYPE}" in
    "")
        ...
        ;;
    "ccm"|"upgrade")
        cp files/jmxremote.password ~/.local/jmxremote.password
        chmod 400 ~/.local/jmxremote.password
        sudo chmod 777 /usr/lib/jvm/java-1.8.0-openjdk-amd64/jre/lib/management/jmxremote.access
        echo "cassandra     readwrite" >> /usr/lib/jvm/java-1.8.0-openjdk-amd64/jre/lib/management/jmxremote.access
        cat /usr/lib/jvm/java-1.8.0-openjdk-amd64/jre/lib/management/jmxremote.access
